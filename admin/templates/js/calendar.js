...
//******************************************************************************
    ...
    var scwBaseYear        = 2007;

    // How many years do want to be valid and to show in the drop-down list?

    var baseYearOffset     = scwDateNow.getFullYear()-scwBaseYear;
    var scwDropDownYears   = 2+baseYearOffset;
    ...
    var scwTodayCellBorderColour = '#000000';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            '.scw           {padding:1px;vertical-align:middle;border:1px solid #000;background:#f9f9e4;}'       +
            'iframe.scw     {position:absolute;z-index:' + scwZindex    +
                            ';top:0px;left:0px;visibility:hidden;'      +
                            'width:1px;height:1px;}'                    +
            'table.scw      {padding:0px;visibility:hidden;'            +
                            'position:absolute;cursor:default;'         +
                            'width:150px;top:0px;left:0px;'             +
                            'z-index:' + (scwZindex+1)                  +
                            ';text-align:center;}'                      +
        '</style>'  );
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #78785e;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #9999CC;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
            'td.scwWeekNumberHead       {color:             #78785e;}'  +
            '/* Week day headings */'                                   +
            ...
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {border:1px solid #EAEADA;'     +
                                        'background-color:  #e8e8d0;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate            {background-color:  #78785e;'   +
                                        'color:             #ffffff;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #e8e8d0;'   +
                                        'color:             #CC6666;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #e8e8d0;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #d3d2b4;'   +
                                        'color:             #ffffff;}'  +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {border:1px solid #EAEADA;'     +
                                        'background-color:  #d3d2b4;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  #d3d2b4;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #d3d2b4;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #d3d2b4;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot:hover,'                                         +
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;'   +
                                        'color:             #666666;}'  +
            'td.scwFootDisabled         {background-color:  #78785e;'   +
                                        'color:             #FFFFFF;}'  +
        '</style>'
                    );
     ...
     "<table id='scw' class='scw'>" +
       "<tr class='scw'>" +
         "<td class='scw'>" +
          ...
          "<tr class='scw'>" +
            "<td class='scw'>" +
              "<table class='scwCells' cellspacing='2' align='center'>" +
                "<thead>" +
