...
$show_footer  = $script3.': <a href="http://www.maianrecipe.com/" title="'.$script222.'" onclick="window.open(this);return false"><b>'.$script222.'</b></a><br />&copy; 2006-'.date("Y").' Resep Makanan Tradisional. '.$script9;
